...
<head>
  ...
  <title>Laporan Data Identitas Narapidana dan Riwayat kejahatan Narapidana</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Laporan Data Identitas Narapidana dan Riwayat kejahatan Narapidana</b></span>
    </a>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Table Narapidana</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
