...
<div class="login-box">
  <div class="login-logo"> <span class="icon-bar"><img src="a.jpg" width="60px" style="margin-left: -20px; border-radius:10px ;"> <b> Lapas Banyuasin</b></span>
    <a href="index.php"><b>Login</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body"><div class="form-group has-feedback">
    ...
    <form action="cek_login.php" method="post">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary glyphicon glyphicon-ok">SignIn</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
