...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section>
  <img style="margin-left: 17px; margin-top: 20px;" src="p.jpg" class="img-fluid" alt="...">
</section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Indetitas Narapidana</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Riwayat Kejahatan Narapidana</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
